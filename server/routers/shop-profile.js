...
import {
  ...
  get,
  addCatalouge,
} from "../controllers/shop-profile.js";
...
router.post(
  ...
  [
    ...
    validator
      .body("pre_defined_type")
      .isMongoId()
      .withMessage("Invalid predefined type"),
    validator
      .body("user_defined_type")
      .isString()
      .trim()
      .not()
      .isEmpty({ ignore_whitespace: true })
      .withMessage("Invalid user defined type"),
    validator
      .body("about")
      .isString()
      .trim()
    ...
    validator
      ...
      .not()
      .isEmpty({ ignore_whitespace: true })
      .withMessage("Bad profile image"),
    validator
      .body("cover_image")
      .isBase64()
      .not()
      .isEmpty({ ignore_whitespace: true })
      .withMessage("Bad cover image"),
    validator
      .body("cash_on_delivery")
      .optional()
      .isBoolean()
      .withMessage("Invalid cash on delivery"),
    validator
      .body("payment")
      .optional()
      .isArray({ min: 1 })
